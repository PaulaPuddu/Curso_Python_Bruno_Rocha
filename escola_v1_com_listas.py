...
for nome_atividade, atividade in atividades: # interação vai rodar para cada tipo de aula (
    ...
    for aluno in atividade: # para cada aluno de dentro da atividade
        if aluno in sala1: # Se o aluno estiver na sala1
            atividade_sala1.append(aluno) # adicione alune na sala1
        elif aluno in sala2:
